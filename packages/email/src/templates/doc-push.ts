  ...
  <div style="background: #f8f9fa; padding: 32px; border-radius: 8px;">
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 0 0 24px;">
      <tr>
        ...
        <td style="padding: 10px 12px; background: #fff; border: 1px solid #e5e7eb; border-radius: 0 4px 4px 0;">${escapeHtml(props.documentName)}</td>
      </tr>
      <tr>
        <td style="padding: 10px 12px; background: #e5e7eb; font-weight: 600; border-radius: 4px 0 0 4px; margin-top: 4px;">제출자</td>
        <td style="padding: 10px 12px; background: #fff; border: 1px solid #e5e7eb; border-radius: 0 4px 4px 0;">${escapeHtml(props.uploaderName)}</td>
      </tr>
    </table>
