...
- [x] WI-408-refactor FlowStudio_re 마이그레이션 | L1:Phase19 > L2:ImageEngine > L3:Migrate re
- [x] WI-409-test 통합 테스트 + E2E fixture (Google GenAI 1회 + ComfyUI 1회) | L1:Phase19 > L2:ImageEngine > L3:Tests
- [x] WI-410-docs README + CHANGELOG (5 사용 예제) | L1:Phase19 > L2:ImageEngine > L3:Docs

### L2: pbc-block-builder > L3: Top 2 PBC 추출 (4주, 23블록 4 출력)
- [x] WI-501-feat pbc-block-builder 스켈레톤 + types.ts | L1:Phase19 > L2:BlockBuilder > L3:Skeleton
- [x] WI-502-refactor 23블록 정의 이전 (FlowStudio v2 block-system-design 기반, 카테고리명 확정) | L1:Phase19 > L2:BlockBuilder > L3:Migrate
- [x] WI-503-feat HTML 렌더러 | L1:Phase19 > L2:BlockBuilder > L3:HTML
- [x] WI-504-feat React 렌더러 | L1:Phase19 > L2:BlockBuilder > L3:React
- [x] WI-505-feat Markdown 렌더러 | L1:Phase19 > L2:BlockBuilder > L3:Markdown
- [x] WI-506-feat DOCX element 렌더러 (텍스트/이미지/리스트) | L1:Phase19 > L2:BlockBuilder > L3:DOCX
- [x] WI-507-feat AI 카피 파이프라인 (intent → blocks, 5단계) | L1:Phase19 > L2:BlockBuilder > L3:AI Pipeline
- [x] WI-508-feat 4 PRESETS (랜딩/상세/SNS/문서) | L1:Phase19 > L2:BlockBuilder > L3:Presets
- [x] WI-509-refactor FlowStudio v2 빌더 마이그레이션 | L1:Phase19 > L2:BlockBuilder > L3:Migrate v2
- [x] WI-510-test 통합 테스트 + 데모 (4 출력 포맷 snapshot) | L1:Phase19 > L2:BlockBuilder > L3:Tests
...
- [~] WI-615-refactor ~~apps/flowteams에 app-shell-ux 표준 sidebar+topbar 적용~~ — **취소 (WI-621로 대체)** | L1:Phase19 > L2:Gap > L3:CANCELLED

### L2: module-system > L3: v3 모듈 시스템 + Multi-org tenancy (2026-05-11~)
- [ ] WI-616-feat packages/core-module-system — ModuleConfig + PackConfig + registry + dependency resolver + buildSidebar | L1:Phase19 > L2:ModuleSystem > L3:Core
- [ ] WI-617-feat apps/web/src/app/settings/modules — Pack/Module install/uninstall 카탈로그 UI | L1:Phase19 > L2:ModuleSystem > L3:CatalogUI
- [ ] WI-618-feat 동적 사이드바 — Pack-aware + 권한 + active tenant scope 적용 | L1:Phase19 > L2:ModuleSystem > L3:Sidebar
- [ ] WI-619-feat 모듈 ReBAC — scope permissions (customers:* / payroll:* / matching:* / ...) | L1:Phase19 > L2:ModuleSystem > L3:ReBAC
- [ ] WI-620-feat Multi-org tenancy 모델 — ManagedOrg model + tenantOrgId + Topbar 조직 스위처 | L1:Phase19 > L2:ModuleSystem > L3:MultiOrg
