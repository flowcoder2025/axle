...
- [x] WI-616-feat packages/core-module-system — ModuleConfig + PackConfig + registry + dependency resolver + buildSidebar | L1:Phase19 > L2:ModuleSystem > L3:Core
- [x] WI-617-feat apps/web/src/app/settings/modules — Pack/Module install/uninstall 카탈로그 UI | L1:Phase19 > L2:ModuleSystem > L3:CatalogUI
